...
public class Logs_event
{
	public static void main(String[] args) throws Exception
	{
	    ...
	    dc.setCapability("app","https://github.com/cloudgrey-io/the-app/releases/download/v1.10.0/TheApp-v1.10.0.app.zip");
        ...
        File f=new File("/Users/nrstt/Desktop/logs.json");
        Path p=f.toPath();
        events.save(p);
        //Stop Appium Server
        as.stop();
