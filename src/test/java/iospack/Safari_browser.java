...
public class Safari_browser
{
	public static void main(String[] args) throws Exception
	{
		...
		{
			Thread.sleep(5000);
			//Launch Gmail site and do login via form filling
			...
			{
				System.out.println("No need for signin click");
			}
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("identifier"))).sendKeys("xxxxx@gmail.com");																				
			driver.hideKeyboard();
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[@type='button'])[3]"))).click();																								
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("password"))).sendKeys("xxxxx");																				
			driver.hideKeyboard();
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[@type='button'])[3]"))).click();																								
	        Thread.sleep(5000);
		}
