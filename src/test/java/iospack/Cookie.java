...
public class Cookie
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
	        ...
	        wait.until(ExpectedConditions.presenceOfElementLocated(By.name("user[email]"))).sendKeys("xxxx@gmail.com");
	        driver.findElement(By.name("user[password]")).sendKeys("xxxxxxx");
	        ...
	        Set<org.openqa.selenium.Cookie> cl=driver.manage().getCookies();
	        ArrayList<Cookie> ca=new ArrayList<Cookie>();
	        for(Cookie c:ca)
	        {
