...
public class Custom_Alerts
{
	public static void main(String[] args) throws Exception
	{
		...
		dc.setCapability("app","https://github.com/cloudgrey-io/the-app/releases/download/v1.6.1/TheApp-v1.6.1.app.zip");
		...
		try
		{
	        ...
	        //find the label of the button which is not 'OK' or 'Cancel'
